![](https://github.com/aberestyak/wireguard-ui/workflows/wireguard-ui%20build%20release/badge.svg)
...
| `WG_CONF_TEMPLATE`            | The custom `wg.conf` config file template. Please refer to our [default template](https://github.com/aberestyak/wireguard-ui/blob/master/templates/wg.conf)                                                                                                                        | N/A                                |
...
MIT. See [LICENSE](https://github.com/aberestyak/wireguard-ui/blob/master/LICENSE).
